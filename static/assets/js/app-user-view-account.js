$(function () {
    var e, t, a = $(".datatable-project"), s = $(".datatable-invoice");
    a.length && (e = a.DataTable({
        ...
        columnDefs: [{
            ...
            searchable: !1,
            render: function (e, t, a, s) {
                for (var n = a.team, r = "", l = 0, i = 0; i < n.length && (r += '<li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Kim Karlos" class="avatar avatar-xs pull-up"><img class="rounded-circle" src="' + assetsPath + "img/avatars/" + n[i] + '"  alt="Avatar"></li>',
                    !(2 < ++l)); i++)
                    ;
                return 2 < l && 0 < (a = n.length - 3) && (r += '<li class="avatar avatar-xs"><span class="avatar-initial rounded-circle pull-up text-heading" data-bs-toggle="tooltip" data-bs-placement="top" title="' + a + ' more">+' + a + "</span ></li>"),
                    '<div class="d-flex align-items-center"><ul class="list-unstyled d-flex align-items-center avatar-group mb-0 z-2">' + r + "</ul></div>"
            }
        }, {
            targets: -2,
            render: function (e, t, a, s) {
        ...
        s.length && (t = s.DataTable({
            ...
            order: [[1, "desc"]],
            dom: '<"row mx-6"<"col-sm-6 col-12 d-flex align-items-center justify-content-center justify-content-sm-start mt-6 mt-sm-0"<"head-label">><"col-sm-6 col-12 d-flex justify-content-center justify-content-md-end align-items-baseline"<"dt-action-buttons d-flex justify-content-center flex-md-row align-items-baseline gap-2"lB>>>t<"row mx-6"<"col-sm-12 col-xxl-6 text-center text-xxl-start pb-md-2 pb-xxl-0"i><"col-sm-12 col-xxl-6 d-md-flex justify-content-xxl-end justify-content-center"p>>',
            language: {
                sLengthMenu: "_MENU_",
                search: "",
