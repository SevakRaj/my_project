!function () {
    ...
    for (let o of s.features) {
        ...
        e.className = "marker",
            e.insertAdjacentHTML("afterbegin", '<img src="' + assetsPath + 'img/illustrations/fleet-car.png" alt="Fleet Car" width="20" class="rounded-3" id="carFleet-' + o.properties.message + '">'),
            e.style.width = i + "px",
            e.style.height = l + "px",
            e.style.cursor = "pointer",
            new mapboxgl.Marker(e).setLngLat(o.geometry.coordinates).addTo(a);
    ...
    var t = document.getElementById("carFleet-1")
        , t = (Helpers._addClass("marker-focus", t),
