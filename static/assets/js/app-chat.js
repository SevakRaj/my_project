document.addEventListener("DOMContentLoaded", function () {
    {
        ...
        function v(e, a, c, t) {
            e.forEach(e => {
                ...
                !c || -1 < t.indexOf(c) ? (e.classList.add("d-flex"),
        ...
        e && new PerfectScrollbar(e, {
            ...
            l.forEach(e => {
                e.addEventListener("click", e => {
                    var t = document.querySelector(".chat-sidebar-left-user .avatar")
                        ...
                        , t = (t.removeAttribute("class"),
                            Helpers._addClass("avatar avatar-xl chat-sidebar-avatar " + u[e], t),
            ...
            o.addEventListener("submit", e => {
                e.preventDefault(),
                    n.value && ((e = document.createElement("div")).className = "chat-message-text mt-2",
                        e.innerHTML = '<p class="mb-0 text-break">' + n.value + "</p>",
                        document.querySelector("li:last-child .chat-message-wrapper").appendChild(e),
                        n.value = "",
                        p())
            }
            );
        ...
        h.addEventListener("click", e => {
            ...
            d.length && null != (b = b || webkitSpeechRecognition) && (f = new b,
                y = !1,
                d.on("click", function () {
                    let t = $(this);
