!function () {
    ...
    d = (l = isDarkStyle ? (o = config.colors_dark.cardColor,
        ...
        s = "#333457",
        n = "#3c3e75",
        "#484b9b") : (o = config.colors.cardColor,
    ...
    var c = {
        ...
        , p = (null !== p && new ApexCharts(p, h).render(),
    ...
    p = document.querySelector("#deliveryExceptionsChart"),
        h = {
            chart: {
                height: 396,
                parentHeightOffset: 0,
        ...
        null !== p && new ApexCharts(p, h).render(),
        p = document.querySelector("#shipmentStatisticsChart"),
        h = {
            series: [{
                name: "Shipment",
                type: "column",
