    ...
    return function() {
        ...
        class T {
            constructor(t) {
                ...
                let i;
                var s, n, o;
                "object" === e ? i = C(t) : "string" === e && (o = (s = t).length,
                "#" === s[0] && (4 === o || 5 === o ? n = {
                    r: 255 & 17 * l[s[1]],
                    g: 255 & 17 * l[s[2]],
                    b: 255 & 17 * l[s[3]],
            ...
            hexString() {
                ...
                e = (t => u(t.r) && u(t.g) && u(t.b) && u(t.a))(t) ? c : d,
                t ? "#" + e(t.r) + e(t.g) + e(t.b) + ( (t, e) => t < 255 ? e(t) : "")(t.a, e) : void 0) : void 0;
                var t, e
            }
            hslString() {
        ...
        function zt(t, e, i) {
            ...
            if (t._sorted) {
                ...
                d && (n = kt(Math.min(Dt(r, l, h).lo, i ? s : Dt(e, l, a.getPixelForValue(h)).lo), 0, s - 1)),
                o = u ? kt(Math.max(Dt(r, a.axis, c, !0).hi + 1, i ? 0 : Dt(e, l, a.getPixelForValue(c), !0).hi + 1), n, s) - n : s - n
            }
            return {
                start: n,
                count: o
            ...
            numeric(t, e, i) {
                ...
                if (i.length > 1) {
                    ...
                    o = function(t, e) {
                        ...
                        return Math.abs(i) >= 1 && t !== Math.floor(t) && (i = t - Math.floor(t)),
                        i
                    }(t, i)
                }
        ...
        function le(t, e, i, s, n) {
            ...
            if (!(isNaN(p) || p <= 0)) {
                ...
                f) {
                default:
                    n ? t.ellipse(i, s, n / 2, p, 0, 0, st) : t.arc(i, s, p, 0, st),
                    t.closePath();
                    break;
                case "triangle":
                    c = n ? n / 2 : p,
        ...
        function be(t, e) {
            ...
            t.arc(i + a.topLeft, s + a.topLeft, a.topLeft, 1.5 * it, it, !0),
            t.lineTo(i, s + o - a.bottomLeft),
            t.arc(i + a.bottomLeft, s + o - a.bottomLeft, a.bottomLeft, it, rt, !0),
            t.lineTo(i + n - a.bottomRight, s + o),
            t.arc(i + n - a.bottomRight, s + o - a.bottomRight, a.bottomRight, rt, 0, !0),
            t.lineTo(i + n, s + a.topRight),
            t.arc(i + n - a.topRight, s + a.topRight, a.topRight, 0, -rt, !0),
        ...
        function Pe(t, e) {
            ...
            s && !("" + s).match(_e) && (console.warn('Invalid font style specified: "' + s + '"'),
            s = void 0);
            const n = {
                ...
                get(t, e, i) {
                    return Re(t, e, ( () => function(t, e, i) {
                        ...
                        return tt(r) && a.isScriptable(e) && (r = function(t, e, i, s) {
                            ...
                            let l = e(o, a || s);
                            return r.delete(t),
                            Ee(t, l) && (l = Ve(n._scopes, n, t, l)),
                            l
                        }(e, r, t, i)),
                        I(r) && r.length && (r = function(t, e, i, s) {
        ...
        function Ve(t, e, i, s) {
            ...
            return null !== l && (void 0 === o || o === i || (l = Be(r, a, o, l, s),
            null !== l)) && Ce(Array.from(r), [""], n, o, ( () => function(t, e, i) {
        ...
        function qe(t, e, i, s, n) {
                ...
                !function(t, e="x") {
                    ...
                    !function(t, e, i) {
                        ...
                        for (let c = 0; c < s - 1; ++c)
                            l = h,
                            h = $e(t, c + 1),
                            l && h && (ut(e[c], 0, je) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c],
                            o = i[c + 1] / e[c],
            ...
            e.capBezierPoints && function(t, e) {
                ...
                s = t.length; i < s; ++i)
                    ...
                    r = i < s - 1 && he(t[i + 1], e),
                    o && (n = t[i],
                    a && (n.cp1x = Xe(n.cp1x, e.left, e.right),
                    n.cp1y = Xe(n.cp1y, e.top, e.bottom)),
                    r && (n.cp2x = Xe(n.cp2x, e.left, e.right),
        ...
        const oi = function() {
            ...
            try {
                ...
                Ke() && (window.addEventListener("test", null, e),
        ...
        function pi(t, e, i) {
            ...
            for (let t = c, i = c; t <= d; ++t)
                ...
                m.skip || (p = h(m[s]),
                p !== b && (x = l(p, n, o),
                null === _ && (x || l(n, b, p) && 0 !== r(n, b)) && (_ = 0 === r(p, n) ? t : i),
                null !== _ && (!x || 0 === r(o, p) || l(o, b, p)) && (g.push(gi({
                    start: _,
                    end: t,
                    loop: u,
                    count: a,
        ...
        function xi(t, e) {
            ...
            const i = []
              , s = function(t, e) {
                return Ht(e) ? (i.includes(e) || i.push(e),
                i.indexOf(e)) : e
            };
        ...
        class ki {
            ...
            _createAnimations(t, e) {
                ...
                for (r = o.length - 1; r >= 0; --r) {
                    ...
                    d && d.duration ? (n[l] = c = new wi(d,t,l,h),
                    s.push(c)) : t[l] = h
                }
                return s
            }
            update(t, e) {
                ...
                return i.length ? (yi.add(this._chart, i),
                !0) : void 0
            }
        }
        function Si(t, e) {
        ...
        class zi {
            ...
            updateIndex(t) {
                this.index !== t && Ei(this._cachedMeta),
                this.index = t
            }
            linkScales() {
                const t = this.chart
            ...
            updateRangeFromParsed(t, e, i, s) {
                ...
                s && a && (s.values = a,
                o = Di(s, n, this._cachedMeta.index)),
        ...
        function Fi(t) {
            ...
            const l = () => {
                32767 !== o && -32768 !== o && (Q(a) && (r = Math.min(r, Math.abs(o - a) || r)),
                a = o)
            }
            ;
            for (s = 0,
        ...
        function Ni(t, e, i, s) {
            ...
            (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[Hi(c, a, r, l)] = !0,
            n = h)),
            o[Hi(n, a, r, l)] = !0,
            t.borderSkipped = o
        }
        function Hi(t, e, i, s) {
            var n, o, a;
            return s ? (a = i,
            t = ji(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = ji(t, e, i),
            t
        }
        function ji(t, e, i) {
        ...
        class Yi extends zi {
            ...
            update(t) {
                const e = this.chart
                  ...
                  , r = Math.min((h = a,
                "string" == typeof (l = this.options.cutout) && l.endsWith("%") ? parseFloat(l) / 100 : +l / h), 1);
                var l, h;
        ...
        var Xi = Object.freeze({
            ...
            BarController: class extends zi {
                ...
                _getStacks(t, e) {
                    ...
                    ;
                    for (const i of s)
                        if ((void 0 === e || !a(i)) && ((!1 === n || -1 === o.indexOf(i.stack) || void 0 === n && void 0 === i.stack) && o.push(i.stack),
                        i.index === t))
                            break;
                ...
                _calculateBarValuePixels(t) {
                    ...
                    Math.abs(d) < o) {
                        ...
                        c = m + d,
                        i && !h && (r._stacks[e.axis]._visualValues[s] = e.getValueForPixel(c) - e.getValueForPixel(m))
                    }
                    ...
                    if (e.grouped) {
                        const i = n ? this._getStackCount(t) : e.stackCount
                          , l = "flex" === s.barThickness ? function(t, e, i, s) {
                            ...
                            let o, a;
                            return R(n) ? (o = e.min * i.categoryPercentage,
            ...
            LineController: class extends zi {
                ...
                updateElements(t, e, i, s) {
                    ...
                    for (let i = 0; i < x; ++i) {
                        ...
                        g && (x.parsed = y,
                        x.raw = l.data[i]),
                        c && (x.options = h || this.resolveDataElementOptions(i, f.active ? "active" : s)),
        ...
        function ds(t, e, i, s) {
            ...
            h = 0; o < a; ++o) {
                r = t[o],
                l = r.box,
                l.update(r.width || e.w, r.height || e.h, cs(r.horizontal, e));
            ...
            for (const r of t) {
                ...
                if (r.horizontal) {
                    const s = e.w * h
                      , o = l.size || t.height;
                    Q(l.start) && (a = l.start),
                    t.fullSize ? us(t, n.left, a, i.outerWidth - n.right - n.left, o) : us(t, e.left + l.placed, a, s, o),
                    l.start = a,
                    l.placed += s,
                    a = t.bottom
                } else {
                    const s = e.h * h
                      , a = l.size || t.width;
                    Q(l.start) && (o = l.start),
                    t.fullSize ? us(t, o, n.top, a, i.outerHeight - n.bottom - n.top) : us(t, o, e.top + l.placed, a, s),
                    l.start = o,
                    l.placed += s,
                    o = t.right
                }
        ...
        class Ns extends Ls {
            ...
            getUserBounds() {
                ...
                return t = V(t, Number.POSITIVE_INFINITY),
            ...
            update(t, e, i) {
                ...
                o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = function(t, e) {
                    ...
                    if (a > 0) {
                        ...
                        for (Es(e, h, c, R(s) ? 0 : r - s, r),
                        t = 0,
                        i = a - 1; t < i; t++)
                            Es(e, h, c, o[t], o[t + 1]);
                        return Es(e, h, c, l, R(s) ? e.length : l + s),
                        h
                    }
                    return Es(e, h, c),
                    h
            ...
            calculateLabelRotation() {
                ...
                a = this.maxHeight - Vs(t.grid) - e.padding - Bs(t.title, this.chart.options.font),
                r = Math.sqrt(c * c + d * d),
                l = bt(Math.min(Math.asin(kt((h.highest.height + 6) / o, -1, 1)), Math.asin(kt(a / r, -1, 1)) - Math.asin(kt(d / r, -1, 1)))),
            ...
            fit() {
                ...
                if (o) {
                    ...
                    t.height = Vs(n) + o) : (t.height = this.maxHeight,
                    t.width = Vs(n) + o),
                ...
                for (l = 0; l < e; l += r) {
                    ...
                    R(d) || I(d)) {
                        if (I(d))
                            ...
                            c = d.length; h < c; ++h)
                                x = d[h],
                                R(x) || I(x) || (m = se(s, g.data, g.gc, m, x),
                                b += p)
                    } else
                        m = se(s, g.data, g.gc, m, d),
                        b = p;
                    o.push(m),
                    a.push(b),
                    _ = Math.max(m, _),
            ...
            _computeLabelItems(t) {
                ...
                b = a.length; m < b; ++m) {
                    ...
                    let d, u = M;
                    if (o ? (y = w,
                    "inner" === M && (u = m === b - 1 ? this.options.reverse ? "left" : "right" : 0 === m ? this.options.reverse ? "right" : "left" : "center"),
                    D = "top" === s ? "near" === l || 0 !== g ? -P * S + S / 2 : "center" === l ? -C.highest.height / 2 - e * S + S : -C.highest.height + S / 2 : "near" === l || 0 !== g ? S / 2 : "center" === l ? C.highest.height / 2 - e * S : C.highest.height - P * S,
                    c && (D *= -1),
                    0 === g || t.showLabelBackdrop || (y += S / 2 * Math.sin(g))) : (v = w,
                    D = (1 - P) * S / 2),
                    t.showLabelBackdrop) {
            ...
            drawTitle() {
                ...
                "bottom" === e || "center" === e || z(e) ? (r += o.bottom,
                I(i.text) && (r += n.lineHeight * (i.text.length - 1))) : r += o.top;
                const {titleX: l, titleY: h, maxWidth: c, rotation: d} = function(t, e, i, s) {
                    ...
                    if (t.isHorizontal()) {
                        ...
                        z(i)) {
                            ...
                            f = "center" === i ? (h.bottom + h.top) / 2 + p - e : Rs(t, i, e);
                        d = r - o
                    } else {
                        if (z(i)) {
                            const t = Object.keys(i)[0]
                            ...
                            u = "center" === i ? (h.left + h.right) / 2 - m + e : Rs(t, i, e);
                        f = It(s, a, n),
                        g = "left" === i ? -rt : rt
                    }
                    return {
        ...
        class Hs {
            ...
            unregister(t) {
                const e = this.items
                  ...
                  , s = this.scope;
                i in e && delete e[i],
                s && i in ie[s] && (delete ie[s][i],
                this.override && delete Zt[i])
            }
        }
        class js {
            constructor() {
                ...
                (function(t, e) {
                    ...
                    for (const n of e) {
                        const e = i(n)
                          , o = s(n)
                          , a = (o || e) && t[n];
                        if (e && (tt(a) || rn(a)) || o && I(a))
                            return !0
                    }
                    return !1
                }
                )(o, e) && (n.$shared = !1,
                r = Ae(o, i = tt(i) ? i() : i, this.createResolver(t, i, a)));
                for (const t of e)
                    n[t] = r[t];
                return n
            }
        ...
        function fn(t) {
            return Ke() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]),
        ...
        class xn {
            ...
            constructor(t, e) {
                ...
                this._dataChanges = [],
                gn[this.id] = this,
                a && r ? (yi.listen(this, "complete", dn),
            ...
            _initialize() {
                ...
                this.options.responsive ? this.resize() : ni(this, this.options.devicePixelRatio),
                this.bindEvents(),
            ...
            _resize(t, e) {
                ...
                this._aspectRatio = this.aspectRatio,
                ni(this, a, !0) && (this.notifyPlugins("resize", {
                    size: o
                }),
                ...
                s = e.length; i < s; i++) {
                    ...
                    n.controller)
                        ...
                        const e = $s.getController(o)
                          , {datasetElementType: s, dataElementType: a} = ie.datasets[o];
                        Object.assign(e, {
            ...
            _checkEventBindings() {
                const t = this.options
                  ...
                  , i = new Set(t.events);
                et(e, i) && !!this._responsiveListeners === t.responsive || (this.unbindEvents(),
                this.bindEvents())
            }
            ...
            render() {
                !1 !== this.notifyPlugins("beforeRender", {
                    cancelable: !0
                }) && (yi.has(this) ? this.attached && !yi.running(this) && yi.start(this) : (this.draw(),
                dn({
                    chart: this
                })))
            }
        ...
        function vn(t, e, i, s, n, o) {
            ...
            const p = (g - Math.max(.001, g * d - i / it) / d) / 2
              , m = l + p + f
              , b = n - p - f
              , {outerStart: x, outerEnd: _, innerStart: y, innerEnd: v} = function(t, e, i, s) {
        ...
        function Sn(t, e, i, s) {
            const {points: n, options: o} = e
              , {count: a, start: r, loop: l, ilen: h} = kn(n, i, s)
              , c = function(t) {
        ...
        function Pn(t, e, i, s) {
            const n = e.points
              , {count: o, start: a, ilen: r} = kn(n, i, s)
        ...
        var zn = Object.freeze({
                ...
                draw(t) {
                    ...
                    function(t, e, i, s, n) {
                        ...
                        f && function(t, e, i) {
                            ...
                            t.arc(o, a, r, s - h, i + h),
                            l > n ? (h = n / l,
                            t.arc(o, a, l, i + h, s - h, !0)) : t.arc(o, a, n, i + rt, s - rt),
                            t.closePath(),
                            t.clip()
                        }(t, e, g),
                        o || (vn(t, e, i, s, g, n),
            ...
            BarElement: class extends Ls {
                ...
                draw(t) {
                    const {inflateAmount: e, options: {borderColor: i, backgroundColor: s}} = this
                      ...
                      , a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? be : Rn;
                    var r;
                    t.save(),
            ...
            PointElement: class extends Ls {
                ...
                size(t) {
                    ...
                    return e = Math.max(e, e && t.hoverRadius || 0),
                    2 * (e + (e && t.borderWidth || 0))
                }
                draw(t, e) {
                    const i = this.options;
                    this.skip || i.radius < .1 || !he(this, e, this.size(i) / 2) || (t.strokeStyle = i.borderColor,
        ...
        var Hn = {
            ...
            beforeLayout(t, e, i) {
                ...
                const {data: {datasets: s}, options: n} = t.config
                  , {elements: o} = n;
                if (!i.forceOverride && (Nn(s) || (a = n) && (a.borderColor || a.backgroundColor) || o && Nn(o)))
                    return;
                var a;
                const r = function(t) {
                    let e = 0;
                    return (i, s) => {
                        ...
                        n instanceof Yi ? e = function(t, e) {
                            return t.backgroundColor = t.data.map(( () => Bn(e++))),
                            e
                        }(i, e) : n instanceof Ui ? e = function(t, e) {
                            return t.backgroundColor = t.data.map(( () => Wn(e++))),
                            e
                        }(i, e) : n && (e = function(t, e) {
                            return t.borderColor = Bn(e),
                            t.backgroundColor = Wn(e),
                            ++e
                        }(i, e))
                    }
                }(t);
            ...
            beforeElementsUpdate: (t, e, i) => {
                ...
                t.data.datasets.forEach(( (e, n) => {
                    ...
                    let c, {start: d, count: u} = function(t, e) {
                        ...
                        return l && (n = kt(Dt(e, o.axis, a).lo, 0, i - 1)),
                        s = h ? kt(Dt(e, o.axis, r).hi + 1, n, i) - n : i - n,
                        {
                            start: n,
                            count: s
                        }
                    }(r, l);
                    if (u <= (i.threshold || 4 * s))
                        jn(e);
                    else {
                        switch (R(o) && (e._data = l,
                        delete e.data,
        ...
        function Qn(t, e, i) {
            ...
            for (let n = 0; n < i.length; n++) {
                const o = i[n]
                  , {first: a, last: r, point: l} = to(o, e, "x");
                if (!(!l || a && r))
                    if (a)
                        s.unshift(l);
                    else if (t.push(l),
        ...
        function io(t, e, i) {
                ...
                const n = function(t) {
                    return (t.scale || {}).getPointPositionForValue ? function(t) {
                        const {scale: e, fill: i} = t
                          ...
                          , a = function(t, e, i) {
                            let s;
                            return s = "start" === t ? i : "end" === t ? e.options.reverse ? e.min : e.max : z(t) ? t.value : e.getBaseValue(),
                            s
                        }(i, e, o)
                          , r = [];
                        if (s.grid.circular) {
                        ...
                        const {scale: e={}, fill: i} = t
                          , s = function(t, e) {
                            let i = null;
                            return "start" === t ? i = e.bottom : "end" === t ? i = e.top : z(t) ? i = e.getPixelForValue(t.value) : e.getBasePixel && (i = e.getBasePixel()),
                            i
                        }(i, e);
                        if (F(s)) {
            ...
            s && n.points.length && (ce(t, i),
            function(t, e) {
                const {line: i, target: s, above: n, below: o, area: a, scale: r} = e
                  , l = i._loop ? "angle" : e.axis;
                t.save(),
                "x" === l && o !== n && (so(t, s, a.top),
                no(t, {
                    line: i,
                    target: s,
                    color: n,
        ...
        var ro = {
            ...
            afterDatasetsUpdate(t, e, i) {
                ...
                for (a = 0; a < s; ++a)
                    l = n[a],
                    l && !1 !== l.fill && (l.fill = Zn(n, a, i.propagate))
            },
            beforeDraw(t, e, i) {
        ...
        class ho extends Ls {
                ...
                return this.legendItems.forEach(( (t, o) => {
                    const {itemWidth: p, itemHeight: m} = function(t, e, i, s, n) {
                        const o = function(t, e, i, s) {
                            let n = t.text;
                            return n && "string" != typeof n && (n = n.reduce(( (t, e) => t.length > e.length ? t : e))),
                            e + i.size / 2 + s.measureText(n).width
                        }(s, t, e, i)
                          , a = function(t, e, i) {
                            let s = t;
                            return "string" != typeof e.text && (s = co(e, i)),
                            s
                        }(n, s, e.lineHeight);
                        return {
                            itemWidth: o,
            ...
            _draw() {
                ...
                this.legendItems.forEach(( (_, y) => {
                    ...
                    let k = u.x
                      , S = u.y;
                    if (r.setWidth(this.width),
                    m ? y > 0 && k + w + h > this.right && (S = u.y += x,
                    u.line++,
                    k = u.x = It(n, this.left + h, this.right - i[u.line])) : y > 0 && S + x > this.bottom && (k = u.x = k + e[u.line].width + h,
                    u.line++,
                    S = u.y = It(n, this.top + b + h, this.bottom - e[u.line].height)),
                    function(t, e, i) {
                        if (isNaN(f) || f <= 0 || isNaN(g) || g < 0)
                            return;
                        s.save();
                        const n = B(i.lineWidth, 1);
                        if (s.fillStyle = B(i.fillStyle, a),
                        ...
                        o.usePointStyle) {
                            ...
                            const o = e + Math.max((c - g) / 2, 0)
                              ...
                              , l = ke(i.borderRadius);
                            s.beginPath(),
                            Object.values(l).some((t => 0 !== t)) ? be(s, {
                                x: a,
                                y: o,
                                w: f,
                                h: g,
                    ...
                    k = ( (t, e, i, s) => t === (s ? "left" : "right") ? i : "center" === t ? (e + i) / 2 : e)(M, k + f + d, m ? k + w : this.right, t.rtl),
                    function(t, e, i) {
            ...
            _getLegendItemAt(t, e) {
                ...
                if (St(t, this.left, this.right) && St(e, this.top, this.bottom))
                    ...
                    i = 0; i < n.length; ++i)
                        if (s = n[i],
                        St(t, s.left, s.left + s.width) && St(e, s.top, s.top + s.height))
        ...
        class fo extends Ls {
            ...
            _drawArgs(t) {
                const {top: e, left: i, bottom: s, right: n, options: o} = this
                  , a = o.align;
                let r, l, h, c = 0;
                return this.isHorizontal() ? (l = It(a, i, n),
                h = e + t,
        ...
        function xo(t, e) {
            return e && (I(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
            t
        }
        function _o(t) {
        ...
        function vo(t, e) {
            ...
            b && (p += f * (e.displayColors ? Math.max(r, l.lineHeight) : l.lineHeight) + (b - f) * l.lineHeight + (b - 1) * e.bodySpacing),
        ...
        class Ao extends Ls {
            ...
            getTitle(t, e) {
                const {callbacks: i} = e
                  , s = Co(i, "beforeTitle", this, t)
                  , n = Co(i, "title", this, t)
                  , o = Co(i, "afterTitle", this, t);
                let a = [];
                return a = xo(a, _o(s)),
                a = xo(a, _o(n)),
                a = xo(a, _o(o)),
            ...
            getBody(t, e) {
                ...
                return H(t, (t => {
                    const e = {
                      ...
                      , n = Do(i, t);
                    xo(e.before, _o(Co(n, "beforeLabel", this, t))),
                    xo(e.lines, Co(n, "label", this, t)),
                    xo(e.after, _o(Co(n, "afterLabel", this, t))),
                    s.push(e)
                }
                )),
                s
            ...
            getFooter(t, e) {
                const {callbacks: i} = e
                  , s = Co(i, "beforeFooter", this, t)
                  , n = Co(i, "footer", this, t)
                  , o = Co(i, "afterFooter", this, t);
                let a = [];
                return a = xo(a, _o(s)),
                a = xo(a, _o(n)),
                a = xo(a, _o(o)),
            ...
            _createItems(t) {
                ...
                for (a = 0,
                r = e.length; a < r; ++a)
                    l.push(yo(this.chart, e[a]));
                return t.filter && (l = l.filter(( (e, s, n) => t.filter(e, s, n, i)))),
                t.itemSort && (l = l.sort(( (e, s) => t.itemSort(e, s, i)))),
                H(l, (e => {
                    const i = Do(t.callbacks, e);
                    s.push(Co(i, "labelColor", this, e)),
                    n.push(Co(i, "labelPointStyle", this, e)),
                    o.push(Co(i, "labelTextColor", this, e))
                }
                )),
                this.labelColors = s,
            ...
            getCaretPosition(t, e, i) {
                const {xAlign: s, yAlign: n} = this
                  ...
                  , {topLeft: r, topRight: l, bottomLeft: h, bottomRight: c} = ke(a)
                  , {x: d, y: u} = t
                  , {width: f, height: g} = e;
                let p, m, b, x, _, y;
            ...
            drawTitle(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = So(this, i.titleAlign, i),
            ...
            drawBody(t, e, i) {
                ...
                v = s.length; _ < v; ++_) {
                    ...
                    H(m.before, g),
                    x = m.lines,
                    a && x.length && (this._drawColorBox(e, t, _, f, i),
            ...
            drawFooter(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = So(this, i.footerAlign, i),
            ...
            drawBackground(t, e, i, s) {
                const {xAlign: n, yAlign: o} = this
                  , {x: a, y: r} = t
                  , {width: l, height: h} = i
                  , {topLeft: c, topRight: d, bottomLeft: u, bottomRight: f} = ke(s.cornerRadius);
        ...
        class Io extends Ns {
            ...
            buildTicks() {
                ...
                const s = function(t, e) {
                    ...
                    M = Math.ceil(p / k) * k) : (v = g,
                    M = p),
                    m && b && n && function(t, e) {
                        const i = Math.round(t);
                        return i - e <= t && i + e >= t
                    }((a - o) / n, k / 1e3) ? (w = Math.round(Math.min((a - o) / k, h)),
                    k = (a - o) / w,
                    v = o,
                    M = a) : x ? (v = m ? o : v,
                    M = b ? a : M,
                    w = l - 1,
                    k = (M - v) / w) : (w = (M - v) / k,
                    w = ut(w, Math.round(w), k / 1e3) ? Math.round(w) : Math.ceil(w));
                    ...
                    v < o && P++,
                    ut(Math.round((v + P * k) * y) / y, o, Ro(o, _, t)) && P++) : v < o && P++); P < w; ++P) {
                ...
                return "ticks" === t.bounds && pt(s, this, "value"),
                t.reverse ? (s.reverse(),
                this.start = this.max,
        ...
        class No extends Ns {
            ...
            determineDataLimits() {
                ...
                this._zero && this.min !== this._suggestedMin && !F(this._userMin) && (this.min = t === Vo(this.min, 0) ? Vo(this.min, -1) : Vo(this.min, 0)),
                this.handleTickRangeOptions()
            }
            handleTickRangeOptions() {
            ...
            buildTicks() {
                ...
                return "ticks" === t.bounds && pt(e, this, "value"),
                t.reverse ? (e.reverse(),
                this.start = this.max,
                this.end = this.min) : (this.start = this.min,
                this.end = this.max),
            ...
            getPixelForValue(t) {
                ...
                null === t || isNaN(t) ? NaN : this.getPixelForDecimal(t === this.min ? 0 : (ct(t) - this._startValue) / this._valueRange)
            }
            getValueForPixel(t) {
        ...
        function qo(t, e, i, s) {
            const {ctx: n} = t;
            if (i)
                n.arc(t.xCenter, t.yCenter, e, 0, st);
            else {
        ...
        class Ko extends Io {
            ...
            generateTickLabels(t) {
                Io.prototype.generateTickLabels.call(this, t),
        ...
        function Qo(t, e) {
            ...
            null === a ? null : (n && (a = "week" !== n || !gt(o) && !0 !== o ? i.startOf(a, n) : i.startOf(a, "isoWeek", o)),
            +a)
        }
        function ta(t, e, i, s) {
            const n = Zo.length;
        ...
        class sa extends Ns {
            ...
            buildTicks() {
                ...
                return this._unit = e.unit || (i.autoSkip ? ta(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function(t, e, i, s, n) {
                    for (let o = Zo.length - 1; o >= Zo.indexOf(i); o--) {
                        const i = Zo[o];
                        if (Go[i].common && t._adapter.diff(n, s, i) >= e - 1)
                            return i
                    }
            ...
            _generate() {
                ...
                d++)
                    ea(h, c, f);
                return c !== i && "ticks" !== s.bounds && 1 !== d || ea(h, c, f),
                Object.keys(h).sort(Jo).map((t => +t))
            }
            getLabelForValue(t) {
        ...
        function na(t, e, i) {
            ...
            i ? (e >= t[r].pos && e <= t[l].pos && ({lo: r, hi: l} = Dt(t, "pos", e)),
            ({pos: s, time: o} = t[r]),
            ({pos: n, time: a} = t[l])) : (e >= t[r].time && e <= t[l].time && ({lo: r, hi: l} = Dt(t, "time", e)),
            ({time: s, pos: o} = t[r]),
            ({time: n, pos: a} = t[l]));
            const h = n - s;
            ...
            CategoryScale: class extends Ns {
                ...
                parse(t, e) {
                    ...
                    return ( (t, e) => null === t ? null : kt(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : function(t, e, i, s) {
                        const n = t.indexOf(e);
                        return -1 === n ? ( (t, e, i, s) => ("string" == typeof e ? (i = t.push(e) - 1,
                        s.unshift({
                            index: i,
                            label: e
                        })) : isNaN(e) && (i = null),
                        i))(t, e, i, s) : n !== t.lastIndexOf(e) ? i : n
