!function (e, t) {
    ...
    return function () {
        ...
        function T(e, t, n, r, i, s, o, a, l, c) {
            ...
            for (n.__e = b,
                d = S; d--;)
                null != A[d] && ("function" == typeof n.type && null != A[d].__e && A[d].__e == n.__d && (n.__d = O(r).nextSibling),
                    j(A[d], A[d]));
            if (E)
        ...
        class Ti {
            ...
            insertEntryAt(e, t) {
                ...
                -1 === t.lateral ? (Oi(r, t.level, t.levelCoord),
                    Oi(n, t.level, [e])) : Oi(n[t.level], t.lateral, e),
            ...
            return !(e.eventDrag && !function (e, t, n, r) {
                ...
                for (let r in l) {
                    ...
                    for (let e in h) {
                        ...
                        if (Ln(g, n.range)) {
                            ...
                            if (!1 === p.overlap)
                                return !1;
                            if (y && !y(new Ir(t, u[n.defId], n), new Ir(t, m, o)))
                                return !1
                        }
                    }
                    let b = i.eventStore;
                    for (let e of p.allows) {
                        ...
                        if (i = a ? new Ir(t, a, l) : new Ir(t, m),
                            !e(Rr(s, t), i))
                            return !1
                    }
                }
                ...
                for (let e in o) {
                    ...
                    if (Ln(l, n.range)) {
                        if (!1 === c.overlap)
                            return !1;
                        if (u && !u(new Ir(t, s[n.defId], n), null))
                            return !1
                    }
                }
        ...
        class po {
            constructor(e, t) {
                this.runTaskOption = e,
                    ...
                    this.queue = [],
                    this.delayedRunner = new Ie(this.drain.bind(this))
            }
            request(e, t) {
                this.queue.push(e),
        ...
        class vo {
            constructor(e) {
                this.computeCurrentViewData = Mt(this._computeCurrentViewData),
                    ...
                    this.buildDateEnv = Mt(yo),
                    this.buildTheme = Mt(bo),
                    this.parseToolbars = Mt(ao),
                    this.buildViewSpecs = Mt(qs),
                    this.buildDateProfileGenerator = It(Eo),
                    this.buildViewApi = Mt(Ao),
                    this.buildViewUiProps = It(wo),
                    this.buildEventUiBySource = Mt(So, un),
                    this.buildEventUiBases = Mt(Do),
                    this.parseContextBusinessHours = It(Ro),
                    this.buildTitle = Mt(mo),
                    this.emitter = new Dr,
                    this.actionRunner = new po(this._handleAction.bind(this), this.updateData.bind(this)),
                ...
                Co(c, a) && this.emitter.trigger("loading", !0),
                    this.state = c,
                    this.updateData(),
            ...
            processRawCalendarOptions(e, t) {
                let { locales: n, locale: r } = tn([qt, e, t])
                    ...
                    , a = this.buildPluginHooks(e.plugins || [], go)
        ...
        class Oo extends Rn {
            constructor() {
                super(...arguments),
                    ...
                    this.buildViewPropTransformers = Mt(Po),
                    this.buildToolbarProps = Mt(No),
                    this.headerRef = {
                        current: null
                    },
                    this.footerRef = {
        ...
        class Ho extends oi {
            constructor(e, t = {}) {
                super(),
                    ...
                    this.el = e,
                    this.renderRunner = new Ie(this.handleRenderRequest),
                    new vo({
                        optionOverrides: t,
                        calendarApi: this,
        ...
        class Vo extends _n {
            render() {
                let { props: e, context: t } = this
                    , { options: n } = t
                    , { seg: r } = e
                    , i = Gr(r, n.eventTimeFormat || Lo, t, !0, e.defaultDisplayEventEnd);
                return m(ps, Object.assign({}, e, {
                    elTag: "a",
        ...
        class ta extends xi {
            ...
            render() {
                let { props: e, state: t, context: n } = this
                    , { options: r } = n
                    , i = e.cells.length
                    , s = zo(e.businessHourSegs, i)
                    , o = zo(e.bgEventSegs, i)
                    , a = zo(this.getHighlightSegs(), i)
                    , l = zo(this.getMirrorSegs(), i)
        ...
        class na extends xi {
            constructor() {
                super(...arguments),
                    this.splitBusinessHourSegs = Mt(jo),
                    this.splitBgEventSegs = Mt(jo),
                    this.splitFgEventSegs = Mt(jo),
                    this.splitDateSelectionSegs = Mt(jo),
                    this.splitEventDrag = Mt(Uo),
                    this.splitEventResize = Mt(Uo),
                    this.rowRefs = new ss
            }
            render() {
                let { props: e, context: t } = this
        ...
        class ha {
            constructor(e) {
                this.subjectEl = null,
                    ...
                    da += 1,
                    1 === da && window.addEventListener("touchmove", fa, {
                        passive: !1
                    })
            }
            destroy() {
                this.containerEl.removeEventListener("mousedown", this.handleMouseDown),
                    ...
                    da -= 1,
                    da || window.removeEventListener("touchmove", fa, {
                        passive: !1
                    })
            }
            tryStart(e) {
        ...
        class ga {
            ...
            cleanup() {
                this.mirrorEl && (Oe(this.mirrorEl),
                    this.mirrorEl = null),
                    this.sourceEl = null
            }
            updateElPosition() {
        ...
        class Aa {
            constructor(e) {
                this.el = e,
                    this.origRect = Ai(e),
                    this.scrollCaches = Si(e).map((e => new ma(e, !0)))
            }
            destroy() {
                for (let e of this.scrollCaches)
                    e.destroy()
            ...
            isWithinClipping(e, t) {
                ...
                for (let e of this.scrollCaches)
                    if (!Sa(e.getEventTarget()) && !ai(n, e.clientRect))
                        return !1;
                return !0
            }
        }
        ...
        class Da {
            ...
            handleMove(e, t) {
                ...
                !t && wa(this.movingHit, n) || (this.movingHit = n,
                ...
                for (let s in n) {
                    ...
                    if (a && a.isWithinClipping(e, t)) {
                        ...
                        if (l >= 0 && l < u && c >= 0 && c < h) {
                            ...
                            e && Wn(e.dateProfile.activeRange, e.dateSpan.range) && (this.disablePointCheck || a.el.contains(document.elementFromPoint(l + n - window.scrollX, c + r - window.scrollY))) && (!i || e.layer > i.layer) && (e.componentId = s,
                                e.context = o.context,
                                e.rect.left += n,
                                e.rect.right += n,
                                e.rect.top += r,
        ...
        class Ra extends ri {
            constructor(e) {
                ...
                let { component: t } = this
                    , { options: n } = t.context
                    , r = this.dragging = new Ea(e.el);
                r.pointer.selector = Ra.SELECTOR,
                    ...
                    super(e),
                        ...
                        this.handleDragEnd = e => {
                            ...
                            if (!n.wasTouchScroll) {
                                ...
                                if (n && r && wa(n, r)) {
                                    let { context: r } = t
                                        , i = Object.assign(Object.assign({}, Ca(n.dateSpan, r)), {
                                            dayEl: n.dayEl,
                                            jsEvent: e.origEvent,
                    ...
                    this.context = e,
                        ...
                        this.onDocumentPointerDown = e => {
                            ...
                            this.matchesCancel = !!Ne(n, t),
                                this.matchesEvent = !!Ne(n, Ra.SELECTOR)
                        }
                        ,
        ...
        function La(e) {
            ...
            return m(wn.Consumer, null, (n => {
                ...
                let { dateEnv: r, options: i, viewApi: s } = n
                    , o = null == i.slotLabelFormat ? Ua : Array.isArray(i.slotLabelFormat) ? Qt(i.slotLabelFormat[0]) : Qt(i.slotLabelFormat)
                    , a = {
                        level: 0,
                        time: e.time,
        ...
        class Za extends _n {
            ...
            updateSizing() {
                ...
                var n;
                t.onCoords && null !== t.clientWidth && this.rootElRef.current.offsetHeight && t.onCoords(new Ya(new Di(this.rootElRef.current, (n = this.slatElRefs.currentMap,
        ...
        class al extends _n {
            ...
            renderFillSegs(e, t) {
                let { props: n, context: r } = this
                    , i = il(e, n.date, n.slatCoords, r.options.eventMinHeight).map(((r, i) => {
                        let s = e[i];
                        return m("div", {
                            key: qr(s.eventRange),
        ...
        function ll(e, { todayRange: t, nowDate: n, eventSelection: r, eventDrag: i, eventResize: s }) {
        ...
        class dl extends _n {
            constructor() {
                super(...arguments),
                    this.splitFgEventSegs = Mt(Xa),
                    this.splitBgEventSegs = Mt(Xa),
                    this.splitBusinessHourSegs = Mt(Xa),
                    this.splitNowIndicatorSegs = Mt(Xa),
                    this.splitDateSelectionSegs = Mt(Xa),
                    this.splitEventDrag = Mt($a),
                    this.splitEventResize = Mt($a),
                    this.rootElRef = {
                        current: null
                    },
                    this.cellElRefs = new ss
            ...
            views: {
                timeGrid: {
                    component: class extends Ga {
                        constructor() {
                            super(...arguments),
                                this.buildTimeColsModel = Mt(yl),
                                this.buildSlatMetas = Mt(vl)
                        }
                        render() {
                            let { options: e, dateEnv: t, dateProfileGenerator: n } = this.context
                                ...
                                , f = t => m(gl, Object.assign({}, o.timed, {
                                    dayTableModel: s,
                                    dateProfile: i,
                                    axis: c,
                                    slotDuration: e.slotDuration,
        ...
        try {
            window.Calendar = Ho,
                window.dayGridPlugin = la,
                window.interactionPlugin = Ta,
                window.listPlugin = ja,
                window.timegridPlugin = bl
        } catch (d) { }
        return t
    }()
}
